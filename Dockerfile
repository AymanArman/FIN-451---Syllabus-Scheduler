...
RUN R -e "install.packages(c('jsonlite','tidyverse', 'here', 'lubridate', 'pdftools', 'bslib', 'toastui', 'shinyjs'), dependencies = TRUE, repos = 'https://packagemanager.rstudio.com/cran/latest')" 
